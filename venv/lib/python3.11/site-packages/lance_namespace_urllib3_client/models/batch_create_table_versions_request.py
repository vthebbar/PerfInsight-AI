...
class BatchCreateTableVersionsRequest(BaseModel):
    """
    ...
    entries: List[CreateTableVersionEntry] = Field(description="List of table version entries to create atomically")
    __properties: ClassVar[List[str]] = ["identity", "context", "entries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entries": [CreateTableVersionEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
