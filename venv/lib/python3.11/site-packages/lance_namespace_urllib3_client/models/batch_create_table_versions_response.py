...
class BatchCreateTableVersionsResponse(BaseModel):
    """
    ...
    versions: List[TableVersion] = Field(description="List of created table versions in the same order as the request entries")
    __properties: ClassVar[List[str]] = ["transaction_id", "versions"]
