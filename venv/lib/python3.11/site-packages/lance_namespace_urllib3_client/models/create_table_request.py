...
class CreateTableRequest(BaseModel):
    ...
    storage_options: Optional[Dict[str, StrictStr]] = Field(default=None, description="Storage options that configure overrides for writing table data and metadata during table creation. These are passed to Lance for the write path. ")
    __properties: ClassVar[List[str]] = ["identity", "context", "id", "mode", "properties", "storage_options"]
